...
echo ""
info "The demo includes an HPA configured with minReplicas: 0"
...
echo ""
info "To test scale-to-zero behavior, stop traffic to the demo app and watch replicas drop to 0"
wait_for_user
...
echo "  • Demo app runs with hostUsers: false (User Namespaces GA)"
